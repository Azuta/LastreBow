                ...
                <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20 md:-mt-32 relative">
                    ...
                    <div className="mt-8">
                        <div className="flex border-b border-gray-700 mb-6 overflow-x-auto">
                            ...
                            {canViewKanban && ( <button onClick={() => setActiveTab("management")} className={`px-4 sm:px-6 py-3 text-sm font-semibold border-b-2 flex items-center gap-2 ${activeTab === "management" ? "text-white border-[#ffbade]" : "text-gray-400 border-transparent hover:text-white"}`}><ClipboardIcon /> Gestión</button> )}
                            ...
                            {isAdmin && ( <button onClick={() => setActiveTab("analytics")} className={`px-4 sm:px-6 py-3 text-sm font-semibold border-b-2 flex items-center gap-2 ${activeTab === "analytics" ? "text-white border-[#ffbade]" : "text-gray-400 border-transparent hover:text-white"}`}><BarChartIcon /> Analíticas</button> )}
                            {isMember && ( <button onClick={() => setActiveTab("history")} className={`px-4 sm:px-6 py-3 text-sm font-semibold border-b-2 flex items-center gap-2 ${activeTab === "history" ? "text-white border-[#ffbade]" : "text-gray-400 border-transparent hover:text-white"}`}><HistoryIcon /> Historial</button> )}
                            {isAdmin && ( <button onClick={() => setActiveTab("settings")} className={`px-4 sm:px-6 py-3 text-sm font-semibold border-b-2 flex items-center gap-2 ${activeTab === "settings" ? "text-white border-[#ffbade]" : "text-gray-400 border-transparent hover:text-white"}`}><SettingsIcon /> Configuración</button> )}
                        </div>
                        <div>
                            {activeTab === "projects" && (
                            ...
                            {activeTab === "management" && canViewKanban && <ProjectKanban isAdmin={isAdmin} members={formattedMembers} groupId={groupId} />}
                            ...
                            {activeTab === "community" && ( <div className="max-w-screen-md mx-auto py-8"> <CommentsSection initialComments={[]} mediaId={0} /> </div> )}
                            {activeTab === "members" && (
                                <div className="max-w-screen-md mx-auto space-y-4 py-8">
...
{activeTab === "analytics" && isAdmin && <AnalyticsTab groupId={groupId} />}
                            {activeTab === "settings" && isAdmin && ( <GroupSettingsTab groupData={groupData as ScanGroup} isAdmin={isAdmin} onSettingsSaved={fetchGroupData} /> )}
                        </div>
                    </div>
                </div>
            </main>
