...
const LoginPage = () => {
  ...
  const { signInWithEmail, login, addToast } = useAuth();
      ...
      <div className="min-h-screen flex items-center justify-center bg-[#1a1a24] p-4">
        <div className="w-full max-w-md bg-[#201f31] p-8 rounded-lg shadow-lg">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm"><span className="px-2 bg-[#201f31] text-gray-500">O continúa con</span></div>
          </div>

          <button onClick={login} className="w-full flex items-center justify-center gap-2 bg-[#5865F2] text-white py-3 rounded-lg font-semibold hover:opacity-90 transition-opacity">
